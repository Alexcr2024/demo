                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="banner-img relative ">
                                <img src="/img/banner/h2_banner_shape01.png" alt="" />
                                <img src="/img/banner/h2_banner_shape02.png" alt="" />
                                <img src="/perfil.png" alt="" data-aos="fade-left" data-aos-delay={400} />
                                <img src="/img/images/h3_about_img02.jpg" alt="" />
