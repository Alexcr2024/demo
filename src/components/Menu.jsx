    ...
    <nav className="navbar">
      <ul className="navbar-list">
                  ...
                  <>
                    <li>
                      <Link href="es" onClick={() => handleLanguageChange('es')}>
                        <LazyLoadImage width="20" height="20" src="https://img.icons8.com/color/48/spain.png"
                                       alt="spain"/>
                        Español
                      </Link>
                    </li>
        ...
        <li className="navbar-item">
          <Link href={'https://cotizacion.vascotechnology.com/login'}>
            Cotizar
          </Link>
        </li>

        <li className="navbar-item">
          <Link href={'https://crm.vascotechnology.com/login'}>
            CRM
          </Link>
        </li>
